...
class EditarVacacionBloc {

  Vacacion vacacion;

  EditarVacacionBloc(this.vacacion) {
    medico = vacacion.medico;
  ...
  Future<void> editar() async {
    final _vacacionEditada = Vacacion(
      medico: medico,
      fechaInicio: fechaInicio,
      fechaFin: fechaFin,
      reference: vacacion.reference
    );
    await _vacacionesService.editar(_vacacionEditada);
  }
}